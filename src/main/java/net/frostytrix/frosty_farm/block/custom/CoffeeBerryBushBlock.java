...
public class CoffeeBerryBushBlock extends SweetBerryBushBlock {
    public CoffeeBerryBushBlock(Properties properties) {
        super(properties);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, BlockHitResult pHitResult) {
        ...
        if (i > 1) {
            ...
            popResource(pLevel, pPos, new ItemStack(ModItems.COFFEE_BERRIES.get(), j + (flag ? 1 : 0)));
